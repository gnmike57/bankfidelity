...
:cloud
cls
echo tep 1/1] Running Cloud Smoke Test Launcher...
...
:showcase
cls
echo howcase] Running Compound Task (Calculator -^> Notepad)
...
:audit
cls
echo udit] Running UFO Sequential E2E Architecture Audit...
